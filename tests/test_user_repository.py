...
from app.user_mock import User_mock


@pytest.fixture
def mock_session() -> Session:
    """Pytest fixture to create a mock Session instance."""
    session = create_autospec(Session)                              # unittest.mock
    return session
...
def test_get_users(mock_session: Session) -> None:
    ...
    # Create a fake user
    fake_user = User_mock(id=1, name="Alice", age=28)
    ...
    mock_session.query.assert_called_with(User_mock)
