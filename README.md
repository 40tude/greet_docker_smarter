...
- L'objectif, c'est de lancer automatiquement les tests de ce mini projet (voir le répertoire ``./tests``) à chaque fois que je fais un push de ce projet sur GitHub
